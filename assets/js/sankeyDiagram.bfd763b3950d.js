...
let sankey = {
    ...
    "data": [
        ...
        },
        {
            ...
            "itemStyle": {
                "z": 1,
                "color": "rgb(27,120,0)", opacity: 0.1,
...
sankey_default.data.forEach(e => {
    e.itemStyle.opacity = 1;
    return e
})
...
var option = {
    title: {
        text: "Most frequent purchases for Retail customers by (Gender,Age)",
        textStyle: {
            fontSize: 30,
            top: 20
        },
